...
<div class="container">
    <!-- Container div for overall layout -->

    <div class="row justify-content-center mt-5">
        <!-- Row div with centered content and top margin -->
        ...
        <div class="col-md-6">
            ...
            <div class="card bg-light">
                ...
                <div class="card-header bg-primary text-white">
                    ...
                    <h2 class="text-center">Information sur Produit</h2>
                </div>
                ...
                <div class="card-body">
                    ...
                    <p class="text-success">Téléphone : {{$produit->telephone}}</p>


                    <p class="text-info">Email : {{$produit->email}}</p>
